...
export function studentToFirestore(
  ...
  return {
    ...
    university: student.university?.trim() || null,
    department: student.department?.trim() || null,
    rank: student.rank?.trim() || null,
    imageUrl: student.imageUrl?.trim() || null,
    gururQuote: student.gururQuote?.trim() || null,
    showOnGururTable: student.showOnGururTable === true,
